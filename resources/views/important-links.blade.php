        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 justify-items-center"> 
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
                <a target="_blank" href="https://www.eta.gov.eg/ar/home">
                    <div class="h-80 flex items-center justify-center">
                        <img class="max-h-34 w-full object-contain transition-transform duration-500 group-hover:scale-110" src="{{asset('assets/images/Egyptian Tax Authority.png')}}" alt="">
                    </div>
                </a>

                <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                    <h5 class="text-2xl font-bold text-indigo-900 mb-6">مصلحة الضرائب المصرية</h5>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
                <a target="_blank" href="https://www.gafi.gov.eg/Arabic/eServices/Pages/default.aspx">
                    <div class="h-80 flex items-center justify-center">
                        <img class="max-h-34 w-full object-contain transition-transform duration-500 group-hover:scale-110" src="{{asset('assets/images/General Authority for Investment and Free Zones.jpeg')}}" alt="">
                    </div>
                </a>

                <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                    <h5 class="text-2xl font-bold text-indigo-900 mb-6">الهيئه العامه للاستثمار والمناطق الحره</h5>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
                <a target="_blank" href="https://asa.gov.eg/">
                    <div class="h-80 flex items-center justify-center">
                        <img 
                            class="max-h-34 w-full object-contain transition-transform duration-500 group-hover:scale-110"
                            src="{{asset('assets/images/Central Auditing Organization.jpg')}}"
                            alt="">
                    </div>
                </a>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
                <a target="_blank" href="https://fra.gov.eg/">
                    <div class="h-80 flex items-center justify-center">
                        <img class="max-h-34 w-full object-contain transition-transform duration-500 group-hover:scale-110" src="{{asset('assets/images/Financial Regulatory Authority.jpg')}}" alt="">
                    </div>
                </a>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
                <a target="_blank" href="https://mof.gov.eg/ar">
                    <div class="h-80 flex items-center justify-center">
                        <img class="max-h-34 w-full object-contain transition-transform duration-500 group-hover:scale-110" src="{{asset('assets/images/Ministry of Finance.jpg')}}" alt="">
                    </div>
                </a>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
                <a target="_blank" href="https://www.nosi.gov.eg/ar/Pages/HomePage/Home.aspx">
                    <div class="h-80 flex items-center justify-center">
                        <img class="max-h-34 w-full object-contain transition-transform duration-500 group-hover:scale-110" src="{{asset('assets/images/National Social Insurance Authority.jpg')}}" alt="">
                    </div>
                </a>
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
                <a target="_blank" href="https://www.goeic.gov.eg/ar">
                    <div class="h-80 flex items-center justify-center">
                        <img class="max-h-34 w-full object-contain transition-transform duration-500 group-hover:scale-110" src="{{asset('assets/images/General Organization for Export and Import Control.png')}}" alt="">
                    </div>
                </a>
