...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 justify-items-center"> 
        ...
        <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
            <a href="https://www.eta.gov.eg/ar/home">
            ...
            <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                ...
                <a href="https://www.eta.gov.eg/ar/home" class="mt-auto inline-flex items-center justify-center gap-2 text-white bg-indigo-700 hover:bg-indigo-900 transition-all duration-300 shadow-md font-medium rounded-xl text-lg px-5 py-3">
                    الذهاب 
        ...
        <!-- CARD 2 -->
        <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
            <a href="https://www.gafi.gov.eg/Arabic/eServices/Pages/default.aspx">
                <div class="overflow-hidden">
                    <img class="w-full h-52 object-cover transition-transform duration-500 group-hover:scale-110" src="https://plus.unsplash.com/premium_photo-1679496825341-6071b606886e?q=80&w=880&auto=format&fit=crop" alt="">
                </div>
            </a>
            ...
            <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                ...
                <a href="https://www.gafi.gov.eg/Arabic/eServices/Pages/default.aspx" class="mt-auto inline-flex items-center justify-center gap-2 text-white bg-indigo-700  hover:bg-indigo-900 transition-all duration-300 shadow-md font-medium rounded-xl text-lg px-5 py-3">
                    الذهاب
                    <svg class="w-5 h-5 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m-6-6 6 6-6 6"/>
        ...
        <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
            ...
            <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                ...
                <a href="https://fra.gov.eg/" class="mt-auto inline-flex items-center justify-center gap-2 text-white bg-indigo-700 hover:bg-indigo-900 transition-all duration-300 shadow-md font-medium rounded-xl text-lg px-5 py-3">
                    الذهاب
                    <svg class="w-5 h-5 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m-6-6 6 6-6 6"/>
        ...
        <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
            ...
            <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                ...
                <a href="https://mof.gov.eg/ar" class="mt-auto inline-flex items-center justify-center gap-2 text-white bg-indigo-700 hover:bg-indigo-900 transition-all duration-300 shadow-md font-medium rounded-xl text-lg px-5 py-3">
                    الذهاب
                    <svg class="w-5 h-5 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m-6-6 6 6-6 6"/>
        ...
        <!-- CARD 6 -->
        <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
            <a href="https://www.nosi.gov.eg/ar/Pages/HomePage/Home.aspx">
                <div class="overflow-hidden">
                    <img class="w-full h-52 object-cover transition-transform duration-500 group-hover:scale-110" src="https://plus.unsplash.com/premium_photo-1679496825341-6071b606886e?q=80&w=880&auto=format&fit=crop" alt="">
                </div>
            </a>
            ...
            <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                ...
                <a href="https://www.nosi.gov.eg/ar/Pages/HomePage/Home.aspx" class="mt-auto inline-flex items-center justify-center gap-2 text-white bg-indigo-700 hover:bg-indigo-900 transition-all duration-300 shadow-md font-medium rounded-xl text-lg px-5 py-3">
                    الذهاب
                    <svg class="w-5 h-5 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m-6-6 6 6-6 6"/>
        ...
        <!-- CARD 7 -->
        <div class="group bg-white rounded-2xl overflow-hidden shadow-md border border-gray-200 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl mx-auto w-full max-w-xs">
            <a href="https://www.goeic.gov.eg/ar">
                <div class="overflow-hidden">
                    <img class="w-full h-52 object-cover transition-transform duration-500 group-hover:scale-110" src="https://plus.unsplash.com/premium_photo-1679496825341-6071b606886e?q=80&w=880&auto=format&fit=crop" alt="">
                </div>
            </a>
            ...
            <div class="p-6 text-center flex flex-col flex-1 min-h-[230px]">
                ...
                <a href="https://www.goeic.gov.eg/ar" class="mt-auto inline-flex items-center justify-center gap-2 text-white bg-indigo-700 hover:bg-indigo-900 transition-all duration-300 shadow-md font-medium rounded-xl text-lg px-5 py-3">
                    الذهاب
                    <svg class="w-5 h-5 rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14m-6-6 6 6-6 6"/>
